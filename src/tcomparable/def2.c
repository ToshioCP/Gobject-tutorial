...
# 2 "def.c" 2
 static void viewer_editable_default_init (ViewerEditableInterface *klass);
 GType viewer_editable_get_type (void)
 {
   static volatile gsize g_define_type_id__volatile = 0;
   if ((__extension__ ({ _Static_assert (sizeof *(&g_define_type_id__volatile) == sizeof (gpointer), "Expression evaluates to false");
                        (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : ((void *)0));
                        (!(__extension__ ({ _Static_assert (sizeof *(&g_define_type_id__volatile) == sizeof (gpointer), "Expression evaluates to false");
    ...
    })))
     {
       GType g_define_type_id = g_type_register_static_simple (
        ((GType) ((2) << (2))),
        g_intern_static_string ("ViewerEditable"),
        sizeof (ViewerEditableInterface),
        (GClassInitFunc)(void (*)(void)) viewer_editable_default_init,
        0,
